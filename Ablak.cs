...
namespace Karesz
{
    public partial class Form1
    {
        ...
        static int idő = 0;
        static int[] színkódok = new int[] { üres, fal, fekete, piros, zöld, kék, hó, láva, víz };
        static string[] színnév = new string[] { "üres", "fal", "fekete", "piros", "zöld", "kék", "hó", "láva", "víz" };
        static Color[] színek = { Color.White, Color.Brown, Color.Black, Color.Red, Color.Green, Color.Blue, Color.White, Color.Orange, Color.Blue };
        ...
        private void kéklabel_Click(object sender, EventArgs e) => Átír(kék);
